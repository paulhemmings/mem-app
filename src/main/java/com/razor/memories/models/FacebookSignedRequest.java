...
public class FacebookSignedRequest {
	...
	public String originalSignedRequest;
	...
	public static FacebookSignedRequest getFacebookSignedRequest(String signedRequest) 
		...
		FacebookSignedRequest fsr = new Gson().fromJson(jsonString,  FacebookSignedRequest.class);
		fsr.originalSignedRequest = signedRequest;
